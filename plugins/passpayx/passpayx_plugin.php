<?php
class passpayx_plugin
{
	static public $info = [
		'name'        => 'passpayx', //支付插件英文名称，需和目录名称一致，不能有重复
		'showname'    => '易进件', //支付插件显示名称
		'author'      => '易进件', //支付插件作者
	...
	static private function addOrder($trade_type, $sub_appid=null, $sub_openid=null){
		...
		require_once PAY_ROOT."inc/passpayxClient.php";

		$client = new passpayxClient($channel['appurl'], $channel['appid'], $channel['appkey'], $channel['appsecret']);
