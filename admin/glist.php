...
?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right">结算手续费</label>
						<div class="col-sm-10">
						<div class="input-group"><input type="text" name="settle_rate" id="settle_rate" class="form-control" placeholder="留空则与系统设置一致"/><span class="input-group-addon">%</span></div>
						</div>
					</div>
					<div class="form-group">
	...
	$.ajax({
		...
		success : function(data) {
			...
			if(data.code == 0){
				...
				$("#settle_rate").val(data.settle_rate);
