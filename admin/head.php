            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="<?php echo checkIfActive('pay_channel,pay_roll,pay_type,pay_plugin,pay_weixin') ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-credit-card"></i>
                            支付接口<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="<?php echo checkIfActive('set,gonggao,set_wxkf') ?>">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="./set.php?mod=pay">支付相关配置</a>
                            <li>
                            <li><a href="./set.php?mod=settle">结算规则配置</a>
                            <li>
                            <li><a href="./set.php?mod=transfer">企业付款配置</a>
                            <li>
                            <li><a href="./set.php?mod=oauth">快捷登录配置</a>
                            <li>
                            <li><a href="./set.php?mod=notice">消息提醒配置</a>
                            <li>
                            <li><a href="./set.php?mod=certificate">实名认证配置</a>
                            <li>
                            <li><a href="./gonggao.php">网站公告配置</a></li>
                            <li><a href="./set.php?mod=template">首页模板配置</a>
                            <li>
                            <li><a href="./set.php?mod=mail">邮箱与短信配置</a>
                            <li>
                            <li><a href="./set.php?mod=upimg">网站Logo上传</a>
                            <li>
