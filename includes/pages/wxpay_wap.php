    ...
    <div class="panel panel-primary">
        ...
        <div class="list-group" style="text-align: center;">
            ...
            <div class="list-group-item" style="word-wrap: break-word;">
                <a href="<?php echo $durl ?>"><?php echo $durl ?></a><br/>
                <button id="copy-btn" data-clipboard-text="<?php echo $durl ?>" class="btn btn-info btn-sm">
                    一键复制
                </button>
            </div>
            <div class="list-group-item">
                <small>提示：你可将以上链接发到自己微信的聊天框（在微信顶部搜索框可以搜到自己的微信），点击即可进入支付！</small>
            </div>
            <div class="list-group-item"><a href="weixin://" class="btn btn-primary">打开微信</a>&nbsp;<a href="#"
                                                                                                          onclick="checkresult()"
                                                                                                          class="btn btn-success">检测支付状态</a>
            </div>
        </div>
    </div>
</div>
