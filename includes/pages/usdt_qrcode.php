...
<head>
    ...
    <title>USDT支付中间件</title>
    <link rel="stylesheet" href="/assets/css/ureset.css">
    <style>
        .main {
            width: 320px;
            margin: 0 auto;
...
<script src="<?php echo $cdnpublic?>clipboard.js/2.0.10/clipboard.min.js"></script>
<script src="<?php echo $cdnpublic?>layer/3.5.1/layer.min.js"></script>

<script>
    // 支付时间倒计时
    function clock() {
        let timeout = new Date(<?php echo $code_url['expiration_time']?>000);
        let now = new Date();
