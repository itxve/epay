...
INSERT INTO `pre_config` VALUES ('version', '2032');
...
INSERT INTO `pre_config` VALUES ('sitename', '炮支付');
INSERT INTO `pre_config` VALUES ('title', '炮支付 - 行业领先的免签约支付平台');
INSERT INTO `pre_config` VALUES ('keywords', '炮支付,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付');
INSERT INTO `pre_config` VALUES ('description', '炮支付完美解决支付难题，一站式接入支付宝，微信，QQ钱包，微信wap，帮助开发者快速集成到自己相应产品，效率高，见效快，费率低！');
INSERT INTO `pre_config` VALUES ('orgname', '炮支付');
INSERT INTO `pre_config` VALUES ('kfqq', '123456789');
INSERT INTO `pre_config` VALUES ('template', 'index4');
...
INSERT INTO `pre_config` VALUES ('transfer_name', '炮支付');
INSERT INTO `pre_config` VALUES ('transfer_desc', '炮支付自动结算');
...
INSERT INTO `pre_config` VALUES ('verifytype', '0');
