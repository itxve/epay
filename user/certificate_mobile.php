        ...
        <?php if ($conf['cert_money'] > 0) { ?>
            <div class="alert alert-info alert-dismissible" role="alert" style="line-height: 26px;">
                <p>
                    ...
                    元余额[<a href="recharge.php">点此充值</a>]，认证成功会自动扣除，认证失败不扣费</p>
            </div>
        <?php } ?>
        ...
        <div id="step1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group"><input class="form-control" type="text" name="phone"
                                                        value="<?php echo $userrow['phone'] ?>" disabled><a
                                    class="input-group-addon" href="./editinfo.php">修改绑定</a></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-9">
                        <div class="input-group"><font color="red"><i class="fa fa-info-circle"></i>&nbsp;手机号码的实名信息需与所填身份证号码对应，否则无法认证成功</font>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-4"><input type="button" id="certSubmit" value="提交认证"
            ...
            <div class="alert alert-warning alert-dismissible" role="alert"
                ...
                <p>1、为了更好的享受<?php echo $conf['sitename'] ?>
                    提供的服务，本人知晓并同意授权手机号实名认证方式用于验证本人信息的真实性</p>
                <p>
