                ...
                <div class="tab-content">
                    <div class="tab-pane ng-scope active">
                        <div class="row step-line nav nav-pills nav-justified steps verified">
                            ...
                            <div id="tag2"
                                 class="col-sm-12 col-md-4 mt-step-col <?php if ($userrow['cert'] == 1 || $isqrcode) echo 'complete-active'; ?>">
                            ...
                            <div id="tag3"
                                 class="col-sm-12 col-md-4 mt-step-col last <?php if ($userrow['cert'] == 1) echo 'complete-active'; ?>">
                                <div class="mt-step-col-cont row ">
                                    <div class="col-xs-3 bg-primary-l">
                        ...
                        <?php if ($userrow['cert'] == 1 && !isset($_GET['upgrade'])) { ?>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <img src="https://imgcache.qq.com/open_proj/proj_qcloud_v2/mc_2014/user/auth/css/mod/img/sfz.jpg"
                                         class="pull-right">
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <h4>恭喜您已通过<?php echo $conf['sitename'] ?>实名认证！</h4>
                                    <p>
                                        认证类型：<?php echo show_cert_type($userrow['certtype']) ?><?php if ($userrow['certtype'] == 0) echo '&nbsp;&nbsp;<span class="text-muted">[<a href="certificate.php?certtype=1&upgrade=1" style="color: #98a6ad;">升级到企业认证</a></span>]'; ?></p>
                                    <p>认证方式：<?php echo show_cert_method($userrow['certmethod']) ?></p>
                                    <p>
                                        真实姓名：<?php echo showstar((strlen($userrow['certname']) - 3) / 3) . substr($userrow['certname'], -3) ?></p>
                                    <p>
                                        身份证号：<?php echo substr($userrow['certno'], 0, 3) . showstar(11) . substr($userrow['certno'], -4) ?></p>
                        ...
                        <?php } else { ?>
                            ...
                            <?php if ($conf['cert_money'] > 0) { ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="line-height: 26px;">
                                    <p>
                                        认证需要<b><?php echo $conf['cert_money']; ?></b>元，请确保你的账号内有<?php echo $conf['cert_money']; ?>
                                        元余额[<a href="recharge.php">点此充值</a>]，认证成功会自动扣除，认证失败不扣费
                                    </p>
                                </div>
                            <?php } ?>
                            ...
                            <?php if ($page == 'alipayqrcode') { ?>
                                <div id="step2">
                                    <form class="form-horizontal devform">
                                        ...
                                        <center>
                                            <div id="qrcode"></div>
                                            <p class="text-muted" style="line-height: 26px;">
                                                请使用支付宝APP扫描二维码</p>
                                            <?php if (checkmobile()) { ?><p><a href="javascript:openAlipay()"
                                                                               id="jumplink" class="btn btn-success">点此跳转到支付宝</a>
                                            </p><p class="text-muted">到支付宝确认之后请返回此页面查看结果</p><?php } ?>
                                            <p><a href="./certificate.php"
                                                  class="btn btn-default btn-sm">返回重新填写</a></p>
                                        </center>
                                    </form>
                                </div>
                                ...
                                <div id="step2">
                                    <form class="form-horizontal devform">
                                        ...
                                        <center>
                                            ...
                                            <p class="text-muted" style="line-height: 26px;">
                                                请使用支付宝APP扫描二维码</p>
                                            <p><a href="javascript:jumpAlipay()" id="jumplink" class="btn btn-success">点此跳转到支付宝</a>
                                            </p>
                                            <p><a href="./certificate.php"
                                                  class="btn btn-default btn-sm">返回重新填写</a></p>
                                        </center>
                                ...
                                <div id="step2">
                                    <form class="form-horizontal devform">
                                        ...
                                        <center>
                                            ...
                                            <?php if (checkmobile()) { ?><p class="text-muted"
                                                                            style="line-height: 26px;">
                                                手机用户可保存上方二维码到手机中</p><p class="text-muted"
                                                                                       style="line-height: 26px;">
                                                微信扫一扫中选择“相册”即可</p><?php } ?>
                                            <p><a href="./certificate.php"
                                                  class="btn btn-default btn-sm">返回重新填写</a></p>
                                        </center>
                                    </form>
                            ...
                            <?php } elseif ($page == 'personinput') { ?>
                                <div id="step1">
                                    <form class="form-horizontal devform">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="certification_type">
                                                    <?php if ($conf['cert_open'] == 4) { ?><img
                                                            src="/assets/icon/wxpay.ico"
                                                            width="25">&nbsp;&nbsp;微信快捷认证<?php } else { ?><img
                                                            src="/assets/icon/alipay.ico"
                                                            width="25">&nbsp;&nbsp;支付宝快捷认证<?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-9">
                                                <div class="input-group"><font color="red"><i
                                                                class="fa fa-info-circle"></i>&nbsp;<?php if ($conf['cert_open'] == 4) { ?>微信账号的实名信息需与所填身份证号码对应，否则无法认证成功<?php } else { ?>支付宝账号的实名信息需与所填身份证号码对应，否则无法认证成功<?php } ?>
                                                    </font></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-4"><input type="button" id="certSubmit"
                                                                                         value="提交认证"
                                    ...
                                    <div class="alert alert-warning alert-dismissible" role="alert"
                                         style="line-height: 26px;font-size: 13px;margin-top: 50px;">
                                        <p>1、为了更好的享受<?php echo $conf['sitename'] ?>
                                            提供的服务，本人知晓并同意授权<?php if ($conf['cert_open'] == 4) { ?>微信的实名认证<?php } else { ?>支付宝的实名认证<?php } ?>
                                            方式用于验证本人信息的真实性</p>
                                        <p>
                                            2、本站承诺任何在本网站提交的用户信息，仅限用于本站为用户提供服务，本站承诺为用户的隐私及其他个人信息采取严格保密措施，并在必要时销毁数据。</p>
                                    </div>
                                </div>
                                ...
                                <div id="step1">
                                    <form class="form-horizontal devform">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="certcorpname" value=""
                                                       placeholder="填写公司名称">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="certcorpno" value=""
                                                       placeholder="填写统一社会信用代码">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="certno" value=""
                                                       placeholder="填写法人的身份证号">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-9">
                                                <div class="input-group"><p><font color="red"><i
                                                                    class="fa fa-info-circle"></i>&nbsp;<?php if ($conf['cert_open'] == 4) { ?>微信账号的实名信息需与所填法人身份证号码对应，否则无法认证成功<?php } else { ?>支付宝账号的实名信息需与所填法人身份证号码对应，否则无法认证成功<?php } ?>
                                                        </font></p>
                                                    <p><font color="grey"><i class="fa fa-info-circle"></i>&nbsp;建议先去
                                                            <a href="https://www.tianyancha.com/" target="_blank"
                                                               rel="noopener noreferrer">天眼查</a>
                                                            查询自己企业的信息，直接复制填入，避免填错。</font></p></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-4"><input type="button" id="certSubmit"
        ...
        $("#certSubmit").click(function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    certname: certname,
                    certno: certno,
                    certcorpname: certcorpname,
                    certcorpno: certcorpno,
