...
if(isset($_POST['submit'])){
	...
	$need_money = round($money + $money*$conf['settle_rate']/100,2);
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
          ...
          <form action="?app=<?php echo $app?>" method="POST" role="form">
			<input type="hidden" name="rate" value="<?php echo $conf['settle_rate']?>"/>
...
<?php }?>
		...
		<h4><span class="glyphicon glyphicon-info-sign"></span>注意事项</h4>
		  ...
		  代付手续费和结算手续费一样，是<?php echo $conf['settle_rate']; ?>%<?php if($conf['transfer_minmoney']>0)echo '，单笔最小代付'.$conf['transfer_minmoney'].'元'; if($conf['transfer_maxmoney']>0)echo '，最大代付'.$conf['transfer_maxmoney'].'元';?>
